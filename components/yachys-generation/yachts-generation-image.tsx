import { Box, Button, Img, Skeleton, Text, CircularProgress, CircularProgressLabel } from '@chakra-ui/react';
        ...
        <Box position='relative' w='100%' h='100%'>
          ...
          <Box w='100%' h='100%' display='flex' alignItems='center' justifyContent='center' flexDir='column'>
            <Box display='flex' flexDir='row' mb='0.5rem'>
              ...
              <GenerationButton buttonProps={{isDisabled: isSaved}} variant='grayBgSolid' text='save to our gallery' onClick={()=>{saveToGalleryHandler(); setIsSaved(true);}} />
            </Box>
